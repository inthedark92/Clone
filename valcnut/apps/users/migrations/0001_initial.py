    ...
    operations = [
        migrations.CreateModel(
            ...
            fields=[
                ...
                (
                    "current_mp",
                    models.FloatField(default=50, verbose_name="Текущее MP"),
                ),
                (
                    "last_location",
                    models.CharField(
                        default="central_square", max_length=100, verbose_name="Локация"
                    ),
                ),
                (
                    "is_banned",
